...
def main():
    ...
    # Define pages
    p1 = st.Page(page="./page_directory/1_page_donut_plot.py", title="Donut plot", icon=":material/query_stats:")
    p2 = st.Page(page="./page_directory/2_page_heatmap_plot.py", title="Heatmap", icon=":material/query_stats:")
    p3 = st.Page(page="./page_directory/3_page_scatter_plot.py", title="Scatter plot", icon=":material/query_stats:")
    p4 = st.Page(page="./page_directory/4_page_treemap_plot.py", title="Treemap plot", icon=":material/query_stats:")
